...
export const confirmSignUp = async (username, confirmationCode, phoneNumber, email) => {
    ...
    const result = await new Promise((resolve, reject) => {
      cognitoUser.authenticateUser(authenticationDetails, {
        onSuccess: (session) => {
          ...
          // console.log("Sign-in successful!", session.idToken);
          console.log("Sign-in successful!", session.idToken.payload);
          console.log("Sign-in successful!", session.idToken.payload["cognito:groups"][0]);        
